...
<head>
    ...
    <style>
        ...
        .container {
            ...
            margin-top: 30px;
            padding: 20px;
            background-color: #fff; /* tambahan: latar belakang container */
            border-radius: 10px; /* tambahan: border radius */
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* tambahan: efek bayangan */
        }
        h1 {
            font-size: 50px;
            text-align: center;
