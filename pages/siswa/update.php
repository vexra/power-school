<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    $sql = "update `siswa` set nama='$nama', jenis_kelamin='$jenis_kelamin', tanggal_lahir='$tanggal_lahir', alamat='$alamat', kelas='$kelas', nomor_telepon='$nomor_telepon', email='$email' where id_siswa='$id'";
    $result = mysqli_query($conn, $sql);
...
<body>
  ...
  <div class="shadow-lg max-w-sm mx-auto my-10 p-4 rounded-lg bg-white dark:bg-slate-900">
    <h1 class="font-bold text-lg text-center dark:text-white">Form Update Siswa</h1>
    ...
    <form method="post">
      ...
      <div class="mb-6">
        ...
        <input type="text" id="kelas" name="kelas" autocomplete="off" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="A" required value="<?php echo $kelas; ?>">
      </div>
      <div class="mb-6">
