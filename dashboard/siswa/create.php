<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    $sql = "insert into `siswa` (nama, jenis_kelamin, tanggal_lahir, alamat, kelas, nomor_telepon, email) values('$nama', '$jenis_kelamin', '$tanggal_lahir', '$alamat', '$kelas', '$nomor_telepon', '$email')";
...
<body>
  ...
  <div class="shadow-lg max-w-sm mx-auto my-10 p-4 rounded-lg bg-white dark:bg-slate-900">
    <h1 class="font-bold text-lg text-center dark:text-white">Form Tambah Siswa</h1>
